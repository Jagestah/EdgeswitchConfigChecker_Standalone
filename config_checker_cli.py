#!/usr/bin/env python
#Python Ubiquiti Edgeswitch Config Checker
#Created by JJ Mckeever
import paramiko
import datetime
import os
import sys
...
#Gather details about the device to be connected to.
...
conn.send('show run\n')
time.sleep(1)
conn.send('no terminal length\n')			#Resets terminal length to the default value
...
logfile = open('./'+device_ip+'-logfile.txt', 'a+')
